	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="产品名称" prop="edgeProductTypeName" width="180"></el-table-column>
				<el-table-column label="边缘实例名称" prop="edgeName" width="180"></el-table-column>
				<el-table-column label="边缘编码" prop="edgeSn" width="180"></el-table-column>
				<el-table-column label="秘钥Key" prop="edgeSecretKey" width="180"></el-table-column>
				<el-table-column label="秘钥Id" prop="edgeSecretId" width="180"></el-table-column>
				<el-table-column label="固件版本" prop="edgeFirmwareVersion" width="180" ></el-table-column>
...
export default {
	...
	data() {
		return {
			...
			apiObj: this.$API.abutment.edges.list,
			selection: [],
			search: {
				keyword: null
			}
